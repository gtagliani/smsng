...
import com.samseng.vehicles.repository.VehicleTypeJpaRepository;
...
public class VehicleTypeController {
	...
	static Logger log = Logger.getLogger(VehicleTypeController.class.getName());
	
	
	private static final String ENTITY_TYPE ="vehicleType";
	private static final String ROOT_NAME = "vehicletype";
	...
	@ResponseBody
	public List <VehicleType> dataTable(){
    ...
    public String findAll(Model model) {
		...
		List <VehicleType> companies = service.findAll();
    ...
    public String add(VehicleType entity,Model model) {
		
		log.info(ROOT_NAME + " type controller");
		model.addAttribute(ENTITY_TYPE, entity);
		model.addAttribute("rootName", ROOT_NAME);
		model.addAttribute("allBriefings", brService.findAllNotDeleted());
...
// 
    ...
    public String save(@Valid VehicleType post, BindingResult result,Model model) {
    ...
    public String ajaxSave(@Valid VehicleType post, BindingResult result,Model model) {
    ...
    public String ajaxAdd(VehicleType entity,Model model) {
